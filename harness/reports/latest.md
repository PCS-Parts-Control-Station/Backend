...
5. [CATEGORY_FEATURE] Category feature checks completed.
...
60. [DB_COLUMN_TB_PART_CATEGORY_COMPANY_ID] tb_part_category.company_id exists.
61. [DB_COLUMN_TB_PART_CATEGORY_CATEGORY_NAME] tb_part_category.category_name exists.
62. [DB_COLUMN_TB_PART_CATEGORY_DESCRIPTION] tb_part_category.description exists.
63. [DB_COLUMN_TB_PART_CATEGORY_CREATED_BY] tb_part_category.created_by exists.
64. [DB_COLUMN_TB_PART_CATEGORY_CREATED_AT] tb_part_category.created_at exists.
65. [DB_COLUMN_TB_PART_CATEGORY_UPDATED_AT] tb_part_category.updated_at exists.
